...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  server10_Ethernet | access | 50 | - | - | - |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| ACME-DT | 0.0.0.0/0 | 10.5.4.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf ACME-DT 0.0.0.0/0 10.5.4.1
```

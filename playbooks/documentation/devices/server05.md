...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  server05_Ethernet | access | 40 | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan40 |  ACME-GENERAL  |  10.4.5.105/24  |  -  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| ACME-GENERAL | 0.0.0.0/0 | 10.4.5.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf ACME-GENERAL 0.0.0.0/0 10.4.5.1
```

...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  server04_Ethernet | access | 40 | - | - | - |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan40 |  ACME-GENERAL  |  10.4.4.104/24  |  -  |  -  |  -  |  -  |  -  |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| ACME-GENERAL | 0.0.0.0/0 | 10.4.4.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf ACME-GENERAL 0.0.0.0/0 10.4.4.1
```
